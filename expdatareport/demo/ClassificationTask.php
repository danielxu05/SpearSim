...
$rater = new Rater(md5('test'));
$rater->setEnduser('User1');
...
if ($result3->num_rows > 0) {
    ...
    $sql2 = "SELECT * from EmailPool WHERE (User = ".$profileid." OR User = 0)  AND ID NOT in (SELECT PhishID FROM UserClassification WHERE RaterID = '".$rater->getUserID()."' )";
    echo "<Br>";
...
echo('<div name = "wrapper" id = "wrapper"><div id = "targetinfo" name = "targetinfo"  style="margin:0px;"><center><h2>Profile Information:</h2></center><table><tr>');
...
echo "<br>";
echo "<textarea name=\"email\" id=\"email\" rows=\"100\" cols=\"130\" disabled>";
echo $row['EmailCont'];
if ($row['Attachment']=='1'){
...
?>
<div id = 'wrapperC'>
<form name="myForm" method="post" action="ClassificationTask.php" onsubmit="return onsubmitform();">
